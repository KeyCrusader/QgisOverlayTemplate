const TitleItem = {
	...
	template: `
		<div :class="side, big ? 'big' : ''" class="card top" id="titleItem">
...
const MetadataItem = {
	...
	template: `
		<div :class="side, big ? 'big' : ''" class="card top" id="metadataItem">
			{{ username }}</br>
			{{ datetime }}</br>
			{{ scale }}
		</div>
...
const AttributionItem = {
	...
	template: `
		<div :class="side, big ? 'big' : ''" class="card bottom" id="attributionItem">
...
const LegendItem = {
	...
	template: `
		<div :class="side, big ? 'big' : ''" class="card bottom" id="legendItem">
			<table>
				<tr class="title">
